...
//-------------------------------------------------------------------------------------//
// The following function is called whenver the game ended, whether the player lost
// and whether the player won. Dependet on the status the function will print the fit
// message for the user and will show him his score.
//-------------------------------------------------------------------------------------//
